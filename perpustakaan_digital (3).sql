...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Mar 2024 pada 01.03
...
(44, 1, 'Blue Lock vol 4', 'blue 4.jpg', 'Muneyuki Kashiro', 'Elex Media Komputindo', 2022, 'Pertandingan terakhir seleksi tahap 1 Blue Lock dimulai! Isagi dan teman-teman tim Z mengikuti pertandingan yang menentukan takdir, di mana satu-satunya pilihan hanya menang, ‘kalah atau seri = eliminasi’. Lawan mereka tim V, tim paling kuat di blok 5 yang dibawahi oleh jenius Seishiro Nagi. Apakah kekuatan Z yang dikerahkan mati-matian mampu menghadapi serangan tim V yang luar biasa hebat? Kunci kemenangan adalah kemampuan mereproduksi gol!? Kalau kalah, karier tamat! Ayoo, berjuang, para pemain egois! Kalah = karier tamat! tidak ada pilihan lain selain menang! wajar saja, ‘kan!? itu lah dunia pertarungan!', 8, 1, 'Blue Lock - CH 004 @Manga_Gallery.pdf', '2024-03-06 23:50:19'),
...
(251, 1, 44, '2024-03-07', '12', 'mela', '2024-03-14', '2024-03-06 23:50:19', 'dipinjam');
...
--
ALTER TABLE `peminjaman`
  MODIFY `peminjaman_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=252;
